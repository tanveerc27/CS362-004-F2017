 ...
 ******************************/
 ...
 int main() {
	...
	// 	printf("Number of actions before test %d \n\n", numActBefore);
	//	printf("Number of actions after test %d \n\n", numActAfter);


 	//PASS Condition: Action increases by 1 (2 addition and 1 used)
 	// Modifying code from numActAfter == (numActBefore + 2 - 1) TO numActAfter == (numActBefore + 2)
